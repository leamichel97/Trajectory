# -*- coding: utf-8 -*-
"""
  trajectoire.py generated by WhatsOpt 1.9.1
"""
from optparse import OptionParser
from openmdao.api import Problem
from openmdao.api import NonlinearBlockGS, ScipyKrylov
# from openmdao_extensions.reckless_nonlinear_block_gs import RecklessNonlinearBlockGS
from trajectoire_base import TrajectoireBase, TrajectoireFactoryBase

class Trajectoire(TrajectoireBase):
    """ An OpenMDAO component to encapsulate Trajectoire analysis """
    def __init__(self, **kwargs):
        super(Trajectoire, self).__init__(**kwargs)
