# -*- coding: utf-8 -*-
"""
  trajectoire_base.py generated by WhatsOpt 1.9.1
"""
...
class TrajectoireBase(Group):
    """ An OpenMDAO base component to encapsulate Trajectoire MDA """
    def __init__(self, thrift_client=None, **kwargs):
        super(TrajectoireBase, self). __init__(**kwargs)
...
class TrajectoireFactoryBase(object):
    @staticmethod
